...
if __name__=="__main__":
    ...
    gloss_bnids_fnames = [os.path.join(args.visualsem_path, "dataset", "gloss_files_v2", "glosses.%s.txt.bnids"%lang) for lang in languages]
    gloss_hdf5_fnames  = [os.path.join(args.visualsem_path, "dataset", "gloss_files_v2", "glosses.%s.txt.sentencebert.h5"%lang) for lang in languages]

    # concatenate BNids into single file
    gloss_bnid_outfname = os.path.join(args.visualsem_path, "dataset", "gloss_files_v2", "glosses.combined-%s.bnids"%args.strategy)
    ...
    gloss_hdf5_outfname = os.path.join(args.visualsem_path, "dataset", "gloss_files_v2", 'glosses.combined-%s.h5'%args.strategy)
